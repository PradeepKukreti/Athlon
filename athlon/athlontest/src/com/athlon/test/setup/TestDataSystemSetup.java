...
import com.athlon.test.constants.AthlonTestConstants;
import com.athlon.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = AthlonTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/athlontest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/athlontest/import/reviews.impex");
			...
			importImpexFile(context, "/athlontest/import/cstickets.impex");
		}
	}
}
