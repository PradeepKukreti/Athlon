 ...
 */
package com.athlon.cockpits.setup;
...
import com.athlon.cockpits.constants.AthlonCockpitsConstants;
 ...
 */
@SystemSetup(extension = AthlonCockpitsConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		{
			if (MediaManager.getInstance().getMediaFolderByQualifier(AthlonCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER).size() < 1)
			{
				MediaManager.getInstance().createMediaFolder(AthlonCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER,
						AthlonCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER);
			}
			try
			{
				String prefix = null;
				...
				if (prefix != null){
					importImpexFile(context, "/athloncockpits/reportcockpit/import/" + prefix + "_jasperreports.impex");
				}
			}
