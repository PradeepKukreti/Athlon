...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/athlonstorefront/electronics/en",
						"https://electronics.local:9002/athlonstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/athlonstorefront/electronics/en",
						"https://electronics.local:9002/athlonstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/athlonstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/athlonstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/athlonstorefront/electronics/en",
						"https://electronics.local:9002/athlonstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/athlonstorefront",
						"https://electronics.local:9002/athlonstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/athlonstorefront",
						"https://electronics.local:9002/athlonstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/athlonstorefront/electronics/en",
						"https://electronics.local:9002/athlonstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
