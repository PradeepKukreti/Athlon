 ...
 */
package com.athlon.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(AthlonFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(AthlonFulfilmentProcessConstants.PARENT_PROCESS);
